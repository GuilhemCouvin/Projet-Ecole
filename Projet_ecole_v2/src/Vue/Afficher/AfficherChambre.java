 ...
 * @author Andrej
 */
public class AfficherChambre extends JFrame implements ActionListener{
    ...
    public AfficherChambre(JTextField s)
    {
        ...
        setContentPane(pan);
             ...
             Chambre chambre= chambreDao.find(i, s.getText());
             if(chambre.getNbChambre()!=0)
             {
                 
                 affd.append(chambre.getCodeService()+" "+ Integer.toString(chambre.getNbChambre()) +" " + Integer.toString(chambre.getIdSurveillant())+" "+Integer.toString(chambre.getNbLits())+
                         "\n****************************************************"+"\n");
