 ...
 * @author Andrej
 */
public class ModifierInfirmier extends JFrame implements ActionListener{
    ...
    public ModifierInfirmier(JTextField id)
    {   
        this.id=id;
    ...
    public void actionPerformed(ActionEvent ae) {
       Object source = ae.getSource();
        ...
        {   
            ...
            i.updateInfirmier(id, nom, prenom, adresse, tel, codeService, rotation, salaire);
       ...
       {    
           this.dispose();
           ModifierInfirmierbis m = new ModifierInfirmierbis();
       }
    }
