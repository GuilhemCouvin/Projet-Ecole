 ...
 * @author alex_
 */
public class AjouterTrimestre extends javax.swing.JFrame {

    /**
     * Creates new form AjouterTrimestre
     */
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        ...
        try {
            d.ajouterTrimestre(id1,numero,debut,fin,annee);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AjouterTrimestre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AjouterTrimestre().setVisible(true);
            }
        });
    }
