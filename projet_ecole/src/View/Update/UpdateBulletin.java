 ...
 * @author alex_
 */
public class UpdateBulletin extends javax.swing.JFrame {

    /**
     * Creates new form UpdateBulletin
     */
    ...
    private void initComponents() {
        ...
        inscription.setText("jTextField1");

        jLabel3.setText("Appreciation");

        appreciation.setText("jTextField1");
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        ...
        try {
            d.updateBulletin(id, trimestre, inscription, appreciation);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateBulletin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateBulletin().setVisible(true);
            }
        });
    }
